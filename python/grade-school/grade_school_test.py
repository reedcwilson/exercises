...
class SchoolTest(unittest.TestCase):
    ...
    def test_get_students_cant_mutate(self):
        self.school.add("Franklin", 5)
        grade = self.school.grade(5)
        grade.add("George")
        self.assertCountEqual(self.school.grade(5), ("Franklin", ))

    def create_school(self, students):
